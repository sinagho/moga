...
class ElementScale3D(nn.Module):
    """A learnable element-wise scaler."""

    def __init__(self, embed_dims, init_value=0., requires_grad=True):
        super(ElementScale3D, self).__init__()
...
class ChannelAggregationFFN3D(nn.Module):
    ...
    def __init__(self,
                 ...
                 act_type='GELU',
                 ffn_drop=0.):
        super(ChannelAggregationFFN3D, self).__init__()
...
class MultiOrderDWConv3D(nn.Module):
    ...
    def __init__(self,
        ...
        super(MultiOrderDWConv3D, self).__init__()
...
class MultiOrderGatedAggregation3D(nn.Module):
    ...
    def __init__(self,
        ...
        super(MultiOrderGatedAggregation3D, self).__init__()
...
#     pass
    ...
    def __init__(self,
        ...
        # spatial attention
        self.attn = MultiOrderGatedAggregation3D(
            embed_dims,
        ...
        self.mlp = ChannelAggregationFFN3D(  # DWConv + Channel Aggregation FFN
            embed_dims=embed_dims,
